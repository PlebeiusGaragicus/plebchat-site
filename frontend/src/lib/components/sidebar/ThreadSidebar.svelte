<script lang="ts">
	...
	import { PanelLeftClose, PanelLeft, Plus, MessageSquare, Trash2 } from '@lucide/svelte';
...
<button
	onclick={onToggle}
	class={cn(
		"fixed left-4 top-20 z-40 p-2 rounded-lg transition-all",
...
<!-- Sidebar panel -->
<aside class={cn(
	"fixed left-0 top-14 bottom-0 w-72 z-30",
	...
	<div class="flex flex-col h-full">
		...
		<div class="flex-1 overflow-y-auto p-2">
			{#if !$selectedAgent}
				<div class="px-3 py-8 text-center text-[var(--color-text-muted)] text-sm">
